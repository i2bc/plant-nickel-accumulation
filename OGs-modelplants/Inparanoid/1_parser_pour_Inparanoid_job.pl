...
%hsps=();
	...
	$genomes =~ s/\.blast//;
	print $genomes."\n";
	my @genomes = split (/_vs_/, $genomes); # infile genomeA_vs_genomeB.blast
	my $genomeA = $genomes[0]; print $genomeA."\n";
	my $genomeB = $genomes[1]; print $genomeB."\n";
	my $nomaparser = "$genomeA\.fa-$genomeB\.fa";
